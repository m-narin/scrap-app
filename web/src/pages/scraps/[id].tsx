  ...
  return (
    <>
      <Stack direction="row" spacing={2} sx={{ width: '80%', margin: '20px auto' }}>
        <Typography sx={{ width: '80%', fontWeight: 'lighter' }}>{scrap.created_at}</Typography>
        <Button
          color="error"
          variant="contained"
          sx={{ width: '180px' }}
      ...
      <Stack direction="row" spacing={2} sx={{ width: '80%', margin: '20px auto' }}>
        ...
        >
          <TextField value={scrapEditInput} onChange={(e) => setScrapEditInput(e.target.value)} />
          <Button type="submit" color="success" variant="contained" sx={{ width: '180px' }}>
            スクラップを編集する
          </Button>
        </form>
      </Stack>
      ...
      <Box sx={{ width: '80%', margin: '20px auto', backgroundColor: 'white', padding: '20px' }}>
        ...
        >
          ...
          <Stack mt={4} spacing={2}>
            <Button type="submit" variant="contained" sx={{ width: '180px', marginLeft: 'auto' }}>
              投稿する
            </Button>
          </Stack>
        </form>
