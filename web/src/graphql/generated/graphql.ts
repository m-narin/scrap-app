...
export type GetScrapByIdQuery = {
  ...
  scraps_by_pk?: {
    ...
    title: string
    created_at: any
    comments: Array<{ __typename?: 'comments'; id: number; body: string; created_at: any }>
  } | null
}
...
export type CreateScrapMutation = {
  __typename?: 'mutation_root'
  insert_scraps_one?: { __typename?: 'scraps'; id: number; title: string; created_at: any } | null
}
...
export type EditScrapTitleMutation = {
  __typename?: 'mutation_root'
  update_scraps_by_pk?: { __typename?: 'scraps'; id: number } | null
}
...
export type CreateCommentMutation = {
  __typename?: 'mutation_root'
  insert_comments_one?: { __typename?: 'comments'; id: number; body: string; created_at: any } | null
}
...
export type DeleteScrapMutation = {
  __typename?: 'mutation_root'
  delete_scraps_by_pk?: { __typename?: 'scraps'; id: number } | null
}
...
export function useGetScrapsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetScrapsQuery, GetScrapsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
 ...
 * });
 */
export function useGetScrapByIdQuery(
  baseOptions: Apollo.QueryHookOptions<GetScrapByIdQuery, GetScrapByIdQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetScrapByIdQuery, GetScrapByIdQueryVariables>(GetScrapByIdDocument, options)
}
export function useGetScrapByIdLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetScrapByIdQuery, GetScrapByIdQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useCreateScrapMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateScrapMutation, CreateScrapMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
`
export type EditScrapTitleMutationFn = Apollo.MutationFunction<EditScrapTitleMutation, EditScrapTitleMutationVariables>
...
export function useEditScrapTitleMutation(
  baseOptions?: Apollo.MutationHookOptions<EditScrapTitleMutation, EditScrapTitleMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<EditScrapTitleMutation, EditScrapTitleMutationVariables>(EditScrapTitleDocument, options)
}
export type EditScrapTitleMutationHookResult = ReturnType<typeof useEditScrapTitleMutation>
export type EditScrapTitleMutationResult = Apollo.MutationResult<EditScrapTitleMutation>
...
export function useDeleteScrapMutation(
  baseOptions?: Apollo.MutationHookOptions<DeleteScrapMutation, DeleteScrapMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
